...
$(window).on('scroll', function() {
  ...
  background2.css("left", checkPoint[0]/25-$(window).scrollTop()/25);
  background3.css("left", checkPoint[1]/18-$(window).scrollTop()/18);
  background4.css("left", checkPoint[2]/15-$(window).scrollTop()/15);
  background5.css("left", checkPoint[3]/15-$(window).scrollTop()/15);
  background6.css("left", checkPoint[4]/26-$(window).scrollTop()/26);
  // scrolldown fading
  enterScroll();
  // university fading
  enterUniversity();
...
function enterPortfolio() {
  let scrollPos = $(window).scrollTop();
  if (scrollPos > checkpoint3 + 2200 && scrollPos < checkpoint3 + 2400) { 
  ...
  } else if (scrollPos > checkpoint3 + 3000 && scrollPos < checkpoint3 + 3200) { 
    ...
    portfolio.fadeIn(300);
  } else if (scrollPos > checkpoint3 + 3900 && scrollPos < checkpoint3 + 4100) { 
    ...
    portfolio.fadeIn(300);
  } else if (scrollPos > checkpoint3 + 4700 && scrollPos < checkpoint3 + 4900) { 
