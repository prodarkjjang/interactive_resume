...
let portrait1Left = 0;
let portrait1Right = 0;
let portrait2Left = 0;
let portrait2Right = 0;
let portrait3Left = 0;
let portrait3Right = 0;
let portrait4Left = 0;
let portrait4Right = 0;
...
let statpositionstart = 0;
let statpositionend = 0;
let skillpositionstart = 0;
let skillpositionend = 0;
let scene1end = 0;
let scene2end = 0;
let scene3end = 0;
let scene4end = 0;
...
let uniLeft = 0;
let revealUniLeft = 0;
let revealUniRight = 0;

let intelLeft = 0;
let revealIntelLeft = 0;
let revealIntelRight = 0;

let houseLeft = 0;
let revealHouseLeft = 0;
let revealHouseRight = 0;
...
//-----------------------------------------------------------------------------------------------------------------------------------
// Set the position and height of the sprites based on vw and vh

recalibrate();


// change stats and skills image to smaller for mobile screens
...
function recalibrate() {
  ...
  statpositionstart = currentposition;
  statpositionend = currentposition + vw;
  currentposition += vw;
  skillpositionstart = currentposition + vw/2;
  currentposition += vw/2;
  skillpositionend = currentposition + vw;
  currentposition += vw * 2;
  // Scene 2 - Studies 
  scene1end = currentposition - vw/2;
  ...
  // Revealing the buildings' interior
  uniLeft = university_outside.css("left");
  revealUniLeft = parseInt(uniLeft, 10) - vw/2;
  revealUniRight = revealUniLeft + university_outside.width();

  intelLeft = intel_outside.css("left");
  revealIntelLeft = parseInt(intelLeft, 10) - vw/2;
  revealIntelRight = revealIntelLeft + intel_outside.width();

  houseLeft = house_outside.css("left");
  revealHouseLeft = parseInt(houseLeft, 10) - vw/2;
  revealHouseRight = revealHouseLeft + house_outside.width();

  portrait1Left = parseInt(revealHouseLeft,10) + parseInt(house_inside.css("width"),10)* 0.365;
  portrait1Right = parseInt(revealHouseLeft,10) + parseInt(house_inside.css("width"),10)* 0.395;

  portrait2Left = parseInt(revealHouseLeft,10) + parseInt(house_inside.css("width"),10)* 0.521;
  portrait2Right = parseInt(revealHouseLeft,10) + parseInt(house_inside.css("width"),10)* 0.551;

  portrait3Left = parseInt(revealHouseLeft,10) + parseInt(house_inside.css("width"),10)* 0.676;
  portrait3Right = parseInt(revealHouseLeft,10) + parseInt(house_inside.css("width"),10)* 0.706;

  portrait4Left = parseInt(revealHouseLeft,10) + parseInt(house_inside.css("width"),10)* 0.831;
  portrait4Right = parseInt(revealHouseLeft,10) + parseInt(house_inside.css("width"),10)* 0.861;
}
...
function enterPortfolio() {
  ...
  if (scrollPos > portrait1Left && scrollPos < portrait1Right) {
  ...
  } else if (scrollPos > portrait2Left && scrollPos < portrait2Right) {
    ...
    portfolio.fadeIn(300);
  } else if (scrollPos > portrait3Left && scrollPos < portrait3Right) {
    ...
    portfolio.fadeIn(300);
  } else if (scrollPos > portrait4Left && scrollPos < portrait4Right) {
